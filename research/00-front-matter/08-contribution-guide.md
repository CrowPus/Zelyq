...
Research content is licensed under Creative Commons Attribution 4.0 International as described in [Copyright and License](02-copyright.md). This research-specific license is an explicit exception to the repository's default Apache-2.0 contribution terms for content under `research/`.
