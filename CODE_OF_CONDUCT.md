...
1. **Correction** — A private, written warning, with clarity around the nature of the violation and
   an explanation of why the behaviour was inappropriate.
2. **Warning** — A warning with consequences for continued behaviour, including no interaction with
